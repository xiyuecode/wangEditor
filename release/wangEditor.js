...
Template.prototype = {
    ...
    //通过id获取模板内容
    getTemplateHtmlById: function getTemplateHtmlById(id) {
        for (var i = 0, ilen = this.templates.length; i < ilen; i++) {
    ...
    getTemplateHtml: function getTemplateHtml() {
        var html = '<div><ul class="template-list">';
        for (var i = 0, ilen = this.templates.length; i < ilen; i++) {
            var tpl = this.templates[i];
        ...
        var tabsConfig = [{
            ...
            events: [{
                ...
                fn: function fn(e) {
                    ...
                    var html = _this.getTemplateHtmlById(id);
...
MenuConstructors.template = Template;
